...
int main() {
    // Test Vector (original plaintext)
    ...
    // Print original input (plaintext)
    printf("Original Input (Plaintext): ");
    for (int i = 0; i < 16; i++) {
        printf("%02x ", input[i]);
    }
    printf("\n");
    ...
    printf("Encrypted Output (Ciphertext): ");
    for (int i = 0; i < 16; i++) {
        printf("%02x ", input[i]);
    }
    printf("\n");
    ...
    // Print decrypted output (should match original plaintext)
    printf("Decrypted Output (Plaintext): ");
    for (int i = 0; i < 16; i++) {
        printf("%02x ", input[i]);
    }
    printf("\n");
